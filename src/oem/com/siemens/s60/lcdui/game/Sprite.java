...
public class Sprite extends Layer {
	...
	public void setRefPixelPosition(int var1, int var2) {
		setX(var1 - this.method206(this.refX, this.refY, this.transform));
		setY(var2 - this.method208(this.refX, this.refY, this.transform));
	}

	public int getRefPixelX() {
		return super.getX() + this.method206(this.refX, this.refY, this.transform);
	}

	public int getRefPixelY() {
		return super.getY() + this.method208(this.refX, this.refY, this.transform);
	}
	...
	public final void paint(Graphics var1) {
		if (var1 == null) {
			...
			if (super.isVisible()) {
				var1.drawRegion(this.image, this.anIntArray266[this.frameSequence[this.frame]], this.anIntArray267[this.frameSequence[this.frame]], this.frameWidth, this.frameHeight, this.transform, super.getX(), super.getY(), 20);
			}
	...
	public void setImage(Image var1, int var2, int var3) {
		if (var2 >= 1 && var3 >= 1 && var1.getWidth() % var2 == 0 && var1.getHeight() % var3 == 0) {
			...
			if (this.frameWidth == var2 && this.frameHeight == var3) {
				...
				int var6 = super.getX() + this.method206(this.refX, this.refY, this.transform);
				int var7 = super.getY() + this.method208(this.refX, this.refY, this.transform);
				this.setWidth(var2);
				this.setHeight(var3);
				this.method201(var1, var2, var3, var5);
				this.method202();
				setX(var6 - this.method206(this.refX, this.refY, this.transform));
				setY(var7 - this.method208(this.refX, this.refY, this.transform));
	...
	public final boolean collidesWith(Sprite var1, boolean var2) {
		if (var1.isVisible() && super.isVisible()) {
			int var3 = var1.getX() + var1.anInt412;
			int var4 = var1.getY() + var1.anInt413;
			int var5 = var3 + var1.anInt414;
			int var6 = var4 + var1.anInt415;
			int var7 = super.getX() + this.anInt412;
			int var8 = super.getY() + this.anInt413;
			...
			if (method203(var3, var4, var5, var6, var7, var8, var9, var10)) {
				if (var2) {
					...
					if (this.anInt412 + this.anInt414 > super.getWidth()) {
						var9 = super.getX() + super.getWidth();
					}

					if (this.anInt413 + this.anInt415 > super.getHeight()) {
						var10 = super.getY() + super.getHeight();
					}
					...
					if (var1.anInt412 + var1.anInt414 > var1.getWidth()) {
						var5 = var1.getX() + var1.getWidth();
					}

					if (var1.anInt413 + var1.anInt415 > var1.getHeight()) {
						var6 = var1.getY() + var1.getHeight();
					}
	...
	public final boolean collidesWith(TiledLayer var1, boolean var2) {
		if (var1.isVisible() && super.isVisible()) {
			int var3 = var1.getX();
			int var4 = var1.getY();
			int var5 = var3 + var1.getWidth();
			int var6 = var4 + var1.getHeight();
			int var7 = var1.getCellWidth();
			int var8 = var1.getCellHeight();
			int var9 = super.getX() + this.anInt412;
			int var10 = super.getY() + this.anInt413;
			...
			if (!method203(var3, var4, var5, var6, var9, var10, var11, var12)) {
				...
				if (!var2) {
					...
					if (this.anInt412 + this.anInt414 > super.getWidth()) {
						var11 = super.getX() + super.getWidth();
					}

					if (this.anInt413 + this.anInt415 > super.getHeight()) {
						var12 = super.getY() + super.getHeight();
					}
	...
	private void method202() {
		this.collisionX = 0;
		this.collisionY = 0;
		this.collisionW = super.getWidth();
		this.collisionH = super.getHeight();
	}
	...
	private int method205(int var1, int var2, int var3, int var4) {
		...
		switch (this.transform) {
			...
			case 2:
			case 3:
				var10000 = super.getX() + super.getWidth();
				var10001 = var3;
				break;
			case 4:
			case 5:
			...
			case 6:
			case 7:
				var10000 = super.getY() + super.getHeight();
				var10001 = var4;
				break;
			default:
	...
	private void method209(int var1) {
		setX(super.getX() + this.method206(this.refX, this.refY, this.transform) - this.method206(this.refX, this.refY, var1));
		setY(super.getY() + this.method208(this.refX, this.refY, this.transform) - this.method208(this.refX, this.refY, var1));
		this.method210(var1);
		this.transform = var1;
	}
	...
	private void method210(int var1) {
		switch (var1) {
			...
			case 4:
				...
				setWidth(this.frameHeight);
				setHeight(this.frameWidth);
				return;
			case 5:
