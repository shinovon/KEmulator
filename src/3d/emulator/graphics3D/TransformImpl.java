...
public final class TransformImpl {
    ...
    public final void reset() {
        System.arraycopy(defaultMatrix, 0, this.matrix, 0, 16);
    }

    public final void get(float[] var1) {
        System.arraycopy(this.matrix, 0, var1, 0, 16);
    }

    public final void set(float[] var1) {
        System.arraycopy(var1, 0, this.matrix, 0, 16);
    }

    public final void copy(TransformImpl var1) {
        System.arraycopy(var1.matrix, 0, this.matrix, 0, 16);
    }

    public final void method442() {
        if (!G3DUtils.Invert4x4(this.matrix, 1.0E-10F)) {
            throw new ArithmeticException();
        }
    }

    public final void method445() {
        G3DUtils.Invert4x4(this.matrix, 0.0F);
    }
    ...
    private void method435(int var1, int var2) {
        float var3 = this.matrix[var1];
        this.matrix[var1] = this.matrix[var2];
        this.matrix[var2] = var3;
    }

    public final void method436(TransformImpl var1, boolean var2) {
        float[] var3 = new float[16];
        float[] var4 = (var2 ? this : var1).matrix;
        float[] var5 = (var2 ? var1 : this).matrix;
        ...
        System.arraycopy(var3, 0, this.matrix, 0, 16);
    }
    ...
    public final void method443(float var1, float var2, float var3, float var4) {
        ...
        TransformImpl var6;
        float[] var7 = (var6 = new TransformImpl()).matrix;
    ...
    public final void method444(float var1, float var2, float var3) {
        this.matrix[3] += this.matrix[0] * var1 + this.matrix[1] * var2 + this.matrix[2] * var3;
        this.matrix[7] += this.matrix[4] * var1 + this.matrix[5] * var2 + this.matrix[6] * var3;
        this.matrix[11] += this.matrix[8] * var1 + this.matrix[9] * var2 + this.matrix[10] * var3;
        this.matrix[15] += this.matrix[12] * var1 + this.matrix[13] * var2 + this.matrix[14] * var3;
    }
    ...
    private void method439(float[] var1, int var2) {
        ...
        for (int var4 = 0; var4 < 4; ++var4) {
            float var5 = (var5 = 0.0F + this.matrix[var3 + 0] * var1[var2 + 0]) + this.matrix[var3 + 1] * var1[var2 + 1] + this.matrix[var3 + 2] * var1[var2 + 2] + this.matrix[var3 + 3] * var1[var2 + 3];
    ...
    public final void method440(b var1) {
        float var2 = this.matrix[0] * var1.aFloat608 + this.matrix[1] * var1.aFloat610 + this.matrix[2] * var1.aFloat612 + this.matrix[3] * var1.aFloat614;
        float var3 = this.matrix[4] * var1.aFloat608 + this.matrix[5] * var1.aFloat610 + this.matrix[6] * var1.aFloat612 + this.matrix[7] * var1.aFloat614;
        float var4 = this.matrix[8] * var1.aFloat608 + this.matrix[9] * var1.aFloat610 + this.matrix[10] * var1.aFloat612 + this.matrix[11] * var1.aFloat614;
        float var5 = this.matrix[12] * var1.aFloat608 + this.matrix[13] * var1.aFloat610 + this.matrix[14] * var1.aFloat612 + this.matrix[15] * var1.aFloat614;
        var1.aFloat608 = var2;
        var1.aFloat610 = var3;
        var1.aFloat612 = var4;
        var1.aFloat614 = var5;
