...
public final class GlobalIndicators {
    ...
    public static int setGlobalIndicator(int indicator, int value) throws GlobalIndicatorsException {
        return 0;
    }

    public static int getGlobalIndicator(int indicator) throws GlobalIndicatorsException {
        return 0;
    }
}
