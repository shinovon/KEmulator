...
public final class c extends a implements Runnable {
	...
	private void method257(final float[] array) {
		if (this.af468.aBoolean472) {
			this.af468.method262(SensorMan.method231(super.anInt445).getDescription(), array);
		}
	}

	public final boolean start() {
		final String description = SensorMan.method231(super.anInt445).getDescription();
	...
	public final boolean method225() {
		this.af468.method261(SensorMan.method231(super.anInt445).getDescription());
