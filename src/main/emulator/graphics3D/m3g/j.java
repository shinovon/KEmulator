...
public final class j {
   ...
   public static Object3D[] method697(String var0) throws IOException {
      if(var0 == null) {
         throw new NullPointerException();
      } else {
         try {
            return (new j()).method746(var0);
   ...
   public static Object3D[] method698(byte[] var0, int var1) throws IOException {
      if(var0 == null) {
         throw new NullPointerException();
      } else {
         try {
            return (new j()).method747(var0, var1);
   ...
   private j(Vector var1, String var2) {
      ...
      if(this.anInt1084 > 1 && this.aBoolean1090 && !this.aBoolean1085) {
         ...
         if((var3 = method705(var2 = new g(var1))) == -1) {
            ...
            if(var3 == 0) {
               ...
               var9 = new b(new ByteArrayInputStream(var11));
            }

            ((b)var9).method805();

            while((long)((b)var9).method806() < var7) {
               this.method722(this.method719((b)var9));
            }

            if((long)((b)var9).method806() != var7) {
               Emulator.getEmulator().getLogStream().println("M3GLoader: Section length mismatch!!!");
               return false;
            } else {
   ...
   private Object3D method719(b var1) throws IOException {
      int var2 = method705(var1);
      long var3 = method702(var1);
      long var5 = (long)var1.method806() + var3;
      Object var7 = null;
      switch(var2) {
      case 0:
         if(this.anInt1084 != 0) {
      ...
      case 255:
         ...
         var7 = (new j(this.aVector1091, this.aString1083)).method746(var8)[0];
         break;
      default:
         throw new IOException("Unrecognized object type " + var2 + " (" + this.aString1083 + ").");
      }

      if(var5 != (long)var1.method806()) {
