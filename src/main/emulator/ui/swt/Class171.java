...
final class Class171 extends KeyAdapter {
	...
	public final void keyPressed(final KeyEvent keyEvent) {
		...
		if (Property.method376(this.aClass38_1440).getSelectionIndex() == 0 && KeyMapping.keyToString(String.valueOf(keyEvent.keyCode)) != null) {
			Property.method401(this.aClass38_1440).setText(KeyMapping.keyToString(String.valueOf(keyEvent.keyCode)));
