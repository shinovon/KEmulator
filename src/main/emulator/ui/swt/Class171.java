...
final class Class171 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1440).getSelectionIndex() == 0 && Keyboard.method594(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method401(this.aClass38_1440).setText(Keyboard.method594(String.valueOf(keyEvent.keyCode)));
