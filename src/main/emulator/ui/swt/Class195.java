...
final class Class195 implements PaintListener
{
    ...
    public final void paintControl(final PaintEvent paintEvent) {
        ...
        if (Settings.g2d == 0) {
            ((ImageSWT)Property.method382(this.aClass38_1499)).method12(paintEvent.gc, 0, 0);
            return;
        }
        if (Settings.g2d == 1) {
            ((emulator.graphics2D.awt.d)Property.method382(this.aClass38_1499)).method12(paintEvent.gc, 0, 0);
        }
    }
}
