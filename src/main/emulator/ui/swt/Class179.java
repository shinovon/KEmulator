...
final class Class179 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1449).getSelectionIndex() == 0 && Keyboard.keyToString(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method413(this.aClass38_1449).setText(Keyboard.keyToString(String.valueOf(keyEvent.keyCode)));
