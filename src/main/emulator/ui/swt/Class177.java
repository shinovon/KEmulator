...
final class Class177 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1446).getSelectionIndex() == 0 && Keyboard.keyToString(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method391(this.aClass38_1446).setText(Keyboard.keyToString(String.valueOf(keyEvent.keyCode)));
