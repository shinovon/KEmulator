...
final class Class180 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1450).getSelectionIndex() == 0 && Keyboard.method594(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method407(this.aClass38_1450).setText(Keyboard.method594(String.valueOf(keyEvent.keyCode)));
