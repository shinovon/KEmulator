...
final class Class18 extends FocusAdapter {
	...
	private final Watcher aClass5_585;

	Class18(final Watcher aClass5_585, final TreeItem aTreeItem583, final Text aText584) {
		super();
	...
	public final void focusLost(final FocusEvent focusEvent) {
		...
		Watcher.method315(this.aClass5_585, this.aTreeItem583, this.aText584.getText());
