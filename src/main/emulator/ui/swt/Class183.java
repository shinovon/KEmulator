...
final class Class183 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1454).getSelectionIndex() == 0 && Keyboard.keyToString(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method417(this.aClass38_1454).setText(Keyboard.keyToString(String.valueOf(keyEvent.keyCode)));
