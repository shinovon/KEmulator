...
final class Class182 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1453).getSelectionIndex() == 0 && Keyboard.method594(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method419(this.aClass38_1453).setText(Keyboard.method594(String.valueOf(keyEvent.keyCode)));
