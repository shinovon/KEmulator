...
final class Class181 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1451).getSelectionIndex() == 0 && Keyboard.method594(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method409(this.aClass38_1451).setText(Keyboard.method594(String.valueOf(keyEvent.keyCode)));
