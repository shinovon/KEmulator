...
public final class Class54 implements MouseListener, MouseMoveListener
{
    ...
    private void method462(final Shell shell) {
        ...
        (this.aLink820 = new Link((Composite)this.aShell806, 0)).setText("<a>" + emulator.UILocale.uiText("ABOUT_SUGGESTION", "Suggestions") + "</a>");
        ...
        (this.aLink807 = new Link((Composite)this.aShell806, 0)).setText(emulator.UILocale.uiText("ABOUT_AUTHOR", "Author") + ": <a>Wu.Liang</a>  (c) 2006,2008");
