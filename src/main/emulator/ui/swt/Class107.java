...
final class Class107 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1068).getSelectionIndex() == 0 && Keyboard.keyToString(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method366(this.aClass38_1068).setText(Keyboard.keyToString(String.valueOf(keyEvent.keyCode)));
