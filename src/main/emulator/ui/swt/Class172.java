...
final class Class172 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1441).getSelectionIndex() == 0 && Keyboard.method594(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method399(this.aClass38_1441).setText(Keyboard.method594(String.valueOf(keyEvent.keyCode)));
