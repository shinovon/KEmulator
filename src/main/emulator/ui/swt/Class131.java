...
final class Class131 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1231).getSelectionIndex() == 0 && Keyboard.keyToString(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method388(this.aClass38_1231).setText(Keyboard.keyToString(String.valueOf(keyEvent.keyCode)));
