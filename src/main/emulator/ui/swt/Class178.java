...
final class Class178 extends KeyAdapter
{
    ...
    public final void keyPressed(final KeyEvent keyEvent) {
        ...
        if (Property.method376(this.aClass38_1448).getSelectionIndex() == 0 && Keyboard.keyToString(String.valueOf(keyEvent.keyCode)) != null) {
            Property.method415(this.aClass38_1448).setText(Keyboard.keyToString(String.valueOf(keyEvent.keyCode)));
