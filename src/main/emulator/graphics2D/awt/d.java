...
{
    private BufferedImage aBufferedImage5;
    private b ab6;
    
    public d(final byte[] array) {
        super();
        this.aBufferedImage5 = emulator.graphics2D.c.method171(new ImageData((InputStream)new ByteArrayInputStream(array)));
    }
    
    public d(final BufferedImage bi) {
        super();
        this.aBufferedImage5 = bi;
    }
    
    public d(final int n, final int n2, final boolean b, final int n3) {
        super();
        this.aBufferedImage5 = new BufferedImage(n, n2, b ? 2 : 1);
        final Graphics2D graphics;
        (graphics = this.aBufferedImage5.createGraphics()).setColor(new Color(n3, b));
        graphics.fillRect(0, 0, n, n2);
    }
    
    public final BufferedImage method11() {
        return this.aBufferedImage5;
    }
    ...
    public final void method13(final GC gc, final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7, final int n8) {
        final Image image = new Image((Device)null, emulator.graphics2D.c.method168(this.aBufferedImage5));
        gc.drawImage(image, n, n2, n3, n4, n5, n6, n7, n8);
        image.dispose();
    }
    
    public final IGraphics2D createGraphics() {
        return this.ab6 = new b(this.aBufferedImage5);
    }
    ...
    public final int getWidth() {
        return this.aBufferedImage5.getWidth();
    }
    
    public final int getHeight() {
        return this.aBufferedImage5.getHeight();
    }
    
    public final int[] getData() {
    	try {
	        final int[] data = ((DataBufferInt)this.aBufferedImage5.getRaster().getDataBuffer()).getData();
	        if (!this.aBufferedImage5.getColorModel().hasAlpha()) {
            ...
            final byte[] data = ((DataBufferByte)this.aBufferedImage5.getRaster().getDataBuffer()).getData();
    ...
    public final void setAlpha(final int n, final int n2, final int n3, final int n4, final int n5) {
        if (n5 == 0) {
            final Graphics2D graphics;
            (graphics = this.aBufferedImage5.createGraphics()).setComposite(AlphaComposite.getInstance(1, 0.0f));
    ...
    public final int getRGB(final int n, final int n2) {
        return this.aBufferedImage5.getRGB(n, n2);
    }
    
    public final void saveToFile(final String s) {
        try {
            ImageIO.write(this.aBufferedImage5, "png", new File(s));
        }
        catch (Exception ex) {
            ex.printStackTrace();}
    }
    ...
    public final void copyToClipBoard() {
        emulator.graphics2D.c.method169(this.aBufferedImage5);
    }
