...
SOURCE_FILE="$ROOT_DIR/automation/test-fixtures/src/fixtures/AutoSnapshotFixtureMidlet.java"
BUILD_DIR="$ROOT_DIR/automation/test-fixtures/build-auto-snapshot"
CLASSES_DIR="$BUILD_DIR/classes"
MANIFEST_FILE="$ROOT_DIR/automation/test-fixtures/auto-snapshot-fixture.mf"
DEFAULT_OUTPUT_JAR="$BUILD_DIR/auto-snapshot-fixture.jar"

usage() {
  cat <<'EOF'
Usage:
  ./automation/test-fixtures/build-auto-snapshot-fixture.sh [RUNTIME_CLASSPATH] [OUTPUT_JAR]

Builds the automation auto-snapshot fixture MIDlet JAR.

Arguments:
  RUNTIME_CLASSPATH  Optional KEmulator compile classpath entry. Auto-detected when omitted.
  OUTPUT_JAR         Optional destination jar path. Defaults to ./automation/test-fixtures/build-auto-snapshot/auto-snapshot-fixture.jar
EOF
}
