...
- 14: Не обнаружен один из FIFO
- 15: Сбой подключения к FIFO
- 16: Сбой записи в `statepipe`
- 17: Сбой записи в `readypipe`
- 18: Неожиданное закрытие `readpipe`
- 19: Сбой записи в `buffer`
- 20: Сбой чтения из `inputpipe` (примечание: фронтенд имеет право отключиться от `inputpipe` в любой момент, это
